...
/**
 * Servlet implementation class AlterarVooConsultar
 */
@WebServlet("/AlterarVooConsultar.do")
public class AlterarVooConsultar extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(to != null){
			...
			RequestDispatcher view = request.getRequestDispatcher("TelaDadosConsultaVoo.jsp");
