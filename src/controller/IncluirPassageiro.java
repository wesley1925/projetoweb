...
/**
 * Servlet implementation class IncluirPassageiro
 */
@WebServlet("/IncluirPassageiro.do")
public class IncluirPassageiro extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		to = passageiro.incluir(to);
		
		if(to != null){
		request.setAttribute("passageiro", to);
		RequestDispatcher view = request.getRequestDispatcher("TelaPassageiroIncluido.jsp");
		view.forward(request, response);
		}else{
			RequestDispatcher view = request.getRequestDispatcher("ErroIncluirPassageiro.html");
			view.forward(request, response);
		}
	}
