...
<body>
	...
	<div class="content-wrapper">
		<div class="content">
			<div class="content">
				<h2 class="content-head is-center">Alterar Voo</h2>
			</div>
			<div class="pure-g">
				<div class="l-box-lrg pure-u-1">
					<form class="pure-form pure-form-stacked" action="AlterarVoo.do"
						method="post">
						<fieldset>
								<%
							...
							<label>Codigo da Aeronave</label> <input type="number" name="codAeronave" value="<%=voo.codAeronave%>"> 
							<label>Valor do Voo</label> <input type="number" name="valorVoo" value="<%=voo.valorVoo%>"> 
							<label>Data/Hora de saida</label> <input type="text" name="dataHora" value="<%=voo.dataHora%>"> 
							<label>Escala</label> <input type="text" name="escala" placeholder="Não Possui" value="<%=voo.escala%>"> 
							<label>Origem</label> <input type="text" name="origem" value="<%=voo.origem%>"> 
							<label>Destino</label> <input type="text" name="destino" value="<%=voo.destino%>"> 
