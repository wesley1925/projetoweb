...
<title>Transferir Bilhete</title>
<link rel="stylesheet"
...
<body>
	...
	<div class="content-wrapper">
		<div class="content">
			<div class="content">
				<h2 class="content-head is-center">Transferir Bilhete</h2>
			</div>
			<div class="pure-g">
				<div class="l-box-lrg pure-u-1">
					<form class="pure-form pure-form-stacked" action="TransferirBilhete.do"
						method="post">
						<fieldset>
								<%
							...
							<label>CPF</label> <input type="number" name="cpf" value="<%=bilhete.cpf%>"> 

						</fieldset>
						
						<button type="submit" class="pure-button">Transferir</button>
					</form>
				</div>
			</div>
