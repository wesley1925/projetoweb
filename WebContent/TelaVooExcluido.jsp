...
<body>
	...
	<div class="content-wrapper">
		<div class="content">
			<div class="content">
				<h2 class="content-head is-center">Voo excluido com sucesso!</h2>
			</div>
			<div class="pure-g">
				<div class="l-box-lrg pure-u-1">
					<form class="pure-form pure-form-stacked" action="#"
						...
						<fieldset>
								...
								%>
							<label>Codigo do Voo excluido</label> <input type="text" name="cod" readonly value="<%=voo.codVoo%>"> 
