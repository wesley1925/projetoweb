...
<body>
	...
	<div class="content-wrapper">
		<div class="content">
			<div class="content">
				<h2 class="content-head is-center">Aeronave Incluida</h2>
			</div>
			<div class="pure-g">
				<div class="l-box-lrg pure-u-1">
					<form class="pure-form pure-form-stacked" action="#"
						...
						<fieldset>
							...
							<label>Quantidade de Colunas</label> <input type="text" name="qtdFileiras" readonly value="<%=aeronave.qtdColuna%>"> 
							<label>Quantidade de Fileiras</label> <input type="text" name="qtdColunas" readonly value="<%=aeronave.qtdFileira%>"> 
