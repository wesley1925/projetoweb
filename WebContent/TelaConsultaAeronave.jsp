...
<body>
	...
	<div class="content-wrapper">
		<div class="content">
			<div class="content">
				<h2 class="content-head is-center">Aeronave Consultada</h2>
			</div>
			<div class="pure-g">
				...
				<thead>
				<tr>
				<th>Codigo</th><th>Nome</th><th>Qtd Colunas</th><th>Qtd Fileiras</th><th>Tipo Aeronave</th>
				</tr>
				</thead><tbody>
				<%
				...
				DateFormat f = DateFormat.getDateInstance(DateFormat.SHORT, local);
					...
					out.println("<tr><td>"+aeronave.cod+"</td><td>"+aeronave.nome+"</td><td>"+
							aeronave.qtdColuna+"</td><td>"+aeronave.qtdFileira+
							"</td><td>"+aeronave.tipoAeronave+"</td></tr>");
