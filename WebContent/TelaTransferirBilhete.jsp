...
<title>Bilhete Transferido</title>
<link rel="stylesheet"
...
<body>
	...
	<div class="content-wrapper">
		<div class="content">
			<div class="content">
				<h2 class="content-head is-center">Bilhete Transferido</h2>
			</div>
			<div class="pure-g">
				<div class="l-box-lrg pure-u-1">
					<form class="pure-form pure-form-stacked" action="#"
						...
						<fieldset>
							...
							<label>CPF transferido</label> <input type="number" name="cpf" readonly value="<%=bilhete.cpf%>"> 
