...
<title>Passageiro Excluido</title>
<link rel="stylesheet"
...
<body>
	...
	<div class="content-wrapper">
		<div class="content">
			<div class="content">
				<h2 class="content-head is-center">Passageiro Excluido com sucesso!</h2>
			</div>
			<div class="pure-g">
				<div class="l-box-lrg pure-u-1">
					<form class="pure-form pure-form-stacked" action="#"
						...
						<fieldset>
								...
								%>
							<label>CPF do Passageiro Excluido</label> <input type="text" name="cpf" readonly value="<%=passageiro.cpf%>"> 
