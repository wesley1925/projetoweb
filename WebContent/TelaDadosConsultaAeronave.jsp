...
<body>
	...
	<div class="content-wrapper">
		<div class="content">
			<div class="content">
				<h2 class="content-head is-center">Alterar Aeronave</h2>
			</div>
			<div class="pure-g">
				<div class="l-box-lrg pure-u-1">
					<form class="pure-form pure-form-stacked" action="AlterarAeronave.do"
						method="post">
						<fieldset>
								<%
								...
								%>
							<label>Codigo</label> <input type="number" name="cod" readonly value="<%=aeronave.cod%>"> 
							<label>Nome</label> <input type="text" name="nomeAeronave" value="<%=aeronave.nome%>"> 
							<label>Quantidade de Colunas</label> <input type="number" name="qtdColuna" value="<%=aeronave.qtdColuna%>"> 
							<label>Quantidade de Fileiras</label> <input type="number" name="qtdFileira" value="<%=aeronave.qtdFileira%>"> 
							<label>Tipo Aeronave</label> <input type="text" name="tipoAeronave" value="<%=aeronave.tipoAeronave%>"> 
