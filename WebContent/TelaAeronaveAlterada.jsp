...
<body>
	...
	<div class="content-wrapper">
		<div class="content">
			<div class="content">
				<h2 class="content-head is-center">Aeronave Alterada com sucesso!</h2>
			</div>
			<div class="pure-g">
				<div class="l-box-lrg pure-u-1">
					<form class="pure-form pure-form-stacked" action="#"
						...
						<fieldset>
								...
								%>
							<label>Codigo</label> <input type="text" name="cod" readonly value="<%=aeronave.cod%>"> 
							<label>Nome</label> <input type="text" name="nome" readonly value="<%=aeronave.nome%>"> 
							<label>Quantidade de Colunas</label> <input type="text" name="qtdColunas" readonly value="<%=aeronave.qtdColuna%>"> 
							<label>Quantidade de Fileiras</label> <input type="text" name="qtdFileiras" readonly value="<%=aeronave.qtdFileira%>"> 
							<label>Tipo Aeronave</label> <input type="text" name="tipoAeronave" readonly value="<%=aeronave.tipoAeronave%>"> 
