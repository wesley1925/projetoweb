...
<body>
	...
	<div class="content-wrapper">
		<div class="content">
			<div class="content">
				<h2 class="content-head is-center">Bilhete Estornado com sucesso!</h2>
			</div>
			<div class="pure-g">
				<div class="l-box-lrg pure-u-1">
					<form class="pure-form pure-form-stacked" action="#"
						...
						<fieldset>
								...
								PagamentoCartaoCreditoTO pagamento = (PagamentoCartaoCreditoTO) request.getAttribute("pagamento");
								%>
							<label>Numero do Bilhete</label> <input type="text" name="numeroBilhete" readonly value="<%=pagamento.numeroBilhete%>"> 
